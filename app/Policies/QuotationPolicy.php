...
class QuotationPolicy
{
    ...
    {
        return $user->hasPermissionTo('client_portal.view') || $user->hasPermissionTo('crm.view') || $user->hasPermissionTo('crm.manage') || $user->hasPermissionTo('quotation.manage');
    }
    ...
    public function view(User $user, Quotation $quotation): bool
    {
        ...
        return $user->hasPermissionTo('crm.view') || $user->hasPermissionTo('crm.manage') || $user->hasPermissionTo('quotation.manage');
    }

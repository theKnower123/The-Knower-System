...
const groups: Group[] = [
  ...
  },
  {
    ...
    items: [
      { to: "/support/inbox", labelKey: "Inbox", icon: Ticket, perm: "support.inbox" },
      { to: "/support/dashboard", labelKey: "Support dashboard", icon: BarChart3, perm: "support.view" },
      { to: "/support/queue", labelKey: "Queue", icon: ListTodo, perm: "support.view" },
      { to: "/support/tickets", labelKey: "nav.tickets", icon: Ticket, perm: "support.view" },
      { to: "/support/knowledge-base", labelKey: "Knowledge base", icon: FileText, perm: "support.view" },
      { to: "/support/widget", labelKey: "Chat widget", icon: Sparkles, perm: "support.manage" },
    ],
  },
  {
    labelKey: "Sales & Marketing",
    items: [
      { to: "/marketing/dashboard", labelKey: "Marketing dashboard", icon: BarChart3, perm: "marketing.view" },
      { to: "/marketing/accounts", labelKey: "Social accounts", icon: Share2, perm: "marketing.view" },
      { to: "/marketing/content", labelKey: "Content calendar", icon: CalendarClock, perm: "marketing.view" },
      { to: "/marketing/campaigns", labelKey: "Campaigns", icon: Megaphone, perm: "marketing.view" },
      { to: "/marketing/landing", labelKey: "Landing page", icon: LayoutTemplate, perm: "marketing.view" },
      { to: "/marketing/pipeline", labelKey: "Sales pipeline", icon: TrendingUp, perm: "marketing.view" },
      { to: "/marketing/activity", labelKey: "Activity log", icon: ScrollText, perm: "marketing.view" },
    ],
  },
  {

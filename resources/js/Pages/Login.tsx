...
import { Sparkles, Eye, EyeOff, LogIn, Lock } from "lucide-react";
    ...
    <div className="relative flex min-h-screen items-center justify-center bg-background px-4 py-10">
      ...
      <div className="relative grid w-full max-w-5xl gap-8 md:grid-cols-[1.05fr_1fr]">
        ...
        <div className="rounded-2xl border border-border bg-card p-8 shadow-xl">
          ...
          {/* Dedicated Login with Google Button */}
          <div className="mt-6">
            <Button 
              variant="outline" 
              type="button" 
              onClick={handleGoogleLogin} 
              className="w-full py-5 text-sm font-medium transition-all duration-200 hover:border-primary/50 hover:bg-accent/10"
            >

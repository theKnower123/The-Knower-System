...
export const PERMISSIONS = [
  ...
  "project.view",
  "project.manage",
  "graduation_projects.view",
  "graduation_projects.manage",
  "task.view",
  "task.manage",
  "task.update_status",
  "bug.manage",
...
export const PERMISSION_DESCRIPTIONS: Record<Permission, string> = {
  ...
  "graduation_projects.view": "View graduation project submissions and progress.",
  "graduation_projects.manage": "Quote, approve, deliver, and manage graduation projects.",
  ...
  "marketing.view": "View marketing campaigns and content.",
  "marketing.manage": "Manage marketing campaigns, posts, and landing content.",
  "social.post": "Create and schedule social media posts.",
  "ads.manage": "Manage advertising campaigns and budgets.",
  "content.draft": "Draft marketing content.",
